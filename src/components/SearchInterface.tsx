...
export default function SearchInterface({ userFid, userName, displayName }) {
  ...
  const handleShareSuccess = (url: string) => {
    ...
    notification.className = `fixed top-4 right-4 z-50 bg-black bg-opacity-90 text-white px-4 py-3 rounded-lg flex items-center shadow-lg ${darkMode ? 'text-white' : 'text-white'}`;
    notification.innerHTML = `
      <svg class="w-5 h-5 mr-3 text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
