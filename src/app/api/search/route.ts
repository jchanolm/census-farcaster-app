...
user.bio as bio, user.ogInteractionsCount as fcCredScore,  user.followerCount as followerCount, user.pfpUrl as pfpUrl, avgMentionQuality, castText, 'cast_match' as matchType ORDER BY avgMentionQuality DESC    `;
